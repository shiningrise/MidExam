<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true"
    CodeFile="frmBmkStatus.aspx.cs" Inherits="frmBmkStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    &nbsp;<asp:Button ID="btnInput0" runat="server" Text="准备" OnClick="btnInput_Click" />
    <asp:Button ID="btnInput" runat="server" Text="录入" OnClick="btnInput_Click" />
    <asp:Button ID="btnInput1" runat="server" Text="核对" OnClick="btnInput_Click" />
    <asp:Button ID="btnInput2" runat="server" Text="确认" OnClick="btnInput_Click" />
</asp:Content>
